 ...
 * @example <caption>To match `somewhere.*`</caption>
// Returns /^(?:www.)?(somewhere.[a-z.]{2,}$)/
 * getTLDishHostPattern('somewhere') 
 */
 ...
 * @returns A matching regex pattern
 * @example <caption>To match `somewhere.com`</caption>
 // Returns /^(?:www.)?(somewhere\.com$)/
 * getTLDStrictHostPattern('somewhere.com')
 */
